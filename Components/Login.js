        ...
        <div className="max-w-md absolute -mt-14 bg-white rounded-lg">
            ...
            <div className="relative pt-10 pb-5 px-5">
                ...
                <div>
                    ...
                    <button onClick={() => setOpenLogin(!openLogin)} className="bg-green-700 text-white px-3 py-1 text-lg rounded-lg">Login</button>
                </div>
                <div className='absolute top-3 right-3'>
                    <XIcon onClick={() => setOpenLogin(!openLogin)} className="h-5 w-5 bg-red-500 hover:bg-red-700 text-white rounded-full p-0.5" />
                </div>
            </div>
        </div>
    </div>;
